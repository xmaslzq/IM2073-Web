        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection(
                ...
                if (cartRs.next()) {
                    ...
                    PreparedStatement insertCartStmt = conn.prepareStatement(
                            "INSERT INTO Shopping_Cart (user_id) VALUES (?)", Statement.RETURN_GENERATED_KEYS);
                    ...
                    if (generatedKeys.next()) {
                        ...
                        out.print("{\"error\": \"Failed to create cart for user.\"}");
                        return;
                    }
                }
                ...
                if (checkRs.next()) {
                    ...
                    out.print("{\"success\": \"Book quantity updated in cart.\"}");
                } else {
            ...
            out.print("{\"error\": \"Invalid userId or bookId.\"}");
            e.printStackTrace();
        }
    }
}
